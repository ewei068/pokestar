        ...
        "effectAdd": function(battle, source, target) {
            ...
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    args.damage = 0;
                    args.maxDamage = Math.min(args.maxDamage, args.damage);
                    invulnPokemon.battle.addToLog(`${invulnPokemon.name} is super stretchy!`);
                    ...
                    if (moveType === damageTypes.PHYSICAL) {
                        ...
                        invulnPokemon.battle.addToLog(`${invulnPokemon.name} reflected the move back at ${sourcePokemon.name}!`);
                        moveExecutes[moveId](invulnPokemon.battle, invulnPokemon, sourcePokemon, [sourcePokemon], []);
                    }
                }
            }
            const listenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_DAMAGE_TAKEN, listener);
...
const moveConfig = {
    ...
    "m7-1": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user ignites a stretched arm, delivering a powerful flaming punch. Removes the targets defensive buffs before dealing damage, then leaves the target with a burn.",
    },
    "m10": {
        "name": "Scratch",
        "type": types.NORMAL,
    ...
    "m59": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "A howling blizzard is summoned to strike all enemies. This has a 30% chance to freeze the targets.",
    },
    "m60": {
        "name": "Psybeam",
        "type": types.PSYCHIC,
    ...
    "m111": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.OTHER,
        "description": "The user curls up to conceal weak spots and raise its Defense for 4 turns and boost the power of Rollout.",
    },
    "m113": {
        "name": "Light Screen",
        "type": types.PSYCHIC,
    ...
    "m152": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user attacks the target column with its pincers. If hit, deals a small amount of true damage proportional to the user's attack.",
    },
    "m153": {
        "name": "Explosion",
        "type": types.NORMAL,
    ...
    "m182-1": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.OTHER,
        "description": "The user becomes invulnerable to moves for 1 turn. If hit by Physical attacks, the user stretches its body to the shape of the attack, healing what damage it would have taken. If hit by a Special attack, the user reflects the attack.",
    },
    "m183": {
        "name": "Mach Punch",
        "type": types.FIGHTING,
    ...
    "m183-1": {
        ...
        "tier": moveTiers.BASIC,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user stretches its arm back, then throws a punch at blinding speed, increasing the user's combat readiness by 40%.",
    },
    "m186": {
        "name": "Sweet Kiss",
        "type": types.FAIRY,
    ...
    "m208": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.OTHER,
        "description": "The user restores the by 40% of the user's max HP, as well as cleansing all debuffs and status conditions. Increases healing by 10% for each effect cleansed.",
    },
    "m208-1": {
        "name": "Shuron Hakke",
        "type": types.POISON,
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.OTHER,
        "description": "By consuming a strange liquid substance, the user raises all its stats for 1 turn and restors 25% of its max HP.",
    },
    "m210": {
        "name": "Fury Cutter",
        "type": types.BUG,
        ...
        "tier": moveTiers.BASIC,
        "damageType": damageTypes.PHYSICAL,
        "description": "The target is slashed with scythes or claws. If it hits, the next turn's fury cutter has base 60 power.",
    },
    "m212": {
        "name": "Mean Look",
        "type": types.NORMAL,
    ...
    "m226-1": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.OTHER,
        "description": "The user prepares a delicious meal for an ally, their combat readiness to 100% and giving them sharply increased Attack and Defense for 2 turns.",
    },
    "m229": {
        "name": "Rapid Spin",
        "type": types.NORMAL,
    ...
    "m247": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.SPECIAL,
        "description": "The user hurls a shadowy blob at the target. This may also lower the target's Sp. Def stat for 2 turns with a 85% chance.",
    },
    "m248": {
        "name": "Future Sight",
        "type": types.PSYCHIC,
    ...
    "m284": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user attacks opposing Pokémon with explosive fury. The power of this move decreases proportional to HP lost.",
    },
    "m288": {
        "name": "Grudge",
        "type": types.GHOST,
    ...
    "m309": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The target is hit with a hard punch fired like a meteor. This also raises the users attack for 2 turns before attacking. If the target doesn't faint, remove the buff.",
    },
    "m311": {
        "name": "Weather Ball",
        "type": types.NORMAL,
    ...
    "m316": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.OTHER,
        "description": "The user releases a soothing scent that heals all allies by 25% HP and status conditions and debuffs.",
    },
    "m317": {
        "name": "Rock Tomb",
        "type": types.ROCK,
    ...
    "m359": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user swings and hits with its strong and heavy fist. This lowers the user's Speed for 1 turn.",
    },
    "m361": {
        "name": "Healing Wish",
        "type": types.PSYCHIC,
    ...
    "m370": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user fights the target up close without guarding itself. This also lowers the user's Defense and Special Defense for 1 turn.",
    },
    "m370-1": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user moves horizontally in a rapid fashion, sretching its fists to attack rapidly. This also sharply lowers the user's Defense and Special Defense for 1 turn.",
    },
    "m387": {
        "name": "Last Resort",
        "type": types.NORMAL,
    ...
    "m404": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user slashes at the target by crossing its scythes or claws as if they were a pair of scissors. The primary target is hit twice.",
    },
    "m405": {
        "name": "Bug Buzz",
        "type": types.BUG,
    ...
    "m416-1": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.PHYSICAL,
        "description": "The launches an attack at the target using every bit of its willpower. The user's speed is greatly lowered for 1 turn.",
    },
    "m417": {
        "name": "Nasty Plot",
        "type": types.DARK,
    ...
    "m425": {
        ...
        "tier": moveTiers.BASIC,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user extends its shadow and attacks the target from behind. This deals damage and increases the user's combat readiness by 30%.",
    },
    "m428": {
        "name": "Zen Headbutt",
        "type": types.PSYCHIC,
    ...
    "m453": {
        ...
        "tier": moveTiers.BASIC,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user charges at the target with blinding speed, dealing damage and raising the user's combat readiness by 30%.",
    },
    "m469": {
        "name": "Wide Guard",
        "type": types.ROCK,
    ...
    "m540": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user creates a powerful blast of psychic energy, dealing damage to the target and 50% damage to surrounding Pokemon. Uses the target's Defense stat.",
    },
    "m540-1": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user slashes through the target at a blinding speed, dealing damage to the target and 50% damage to other Pokemon, increasing its combat readiness by 30% for each Pokemon defated. Uses the target's Defense stat.",
    },
    "m542": {
        "name": "Hurricane",
        "type": types.FLYING,
    ...
    "m568": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.OTHER,
        "description": "The user roars loudly to intimidate the target, which lowers their attack and special attack for 1 turn. Ignores miss on the primary target.",
    },
    "m573": {
        "name": "Freeze-Dry",
        "type": types.ICE,
    ...
    "m583": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user plays rough with the target and attacks it. This may also lower the target's attack and speed for 1 turn with a 70% chance.",
    },
    "m585": {
        "name": "Moonblast",
        "type": types.FAIRY,
    ...
    "m620-1": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user launches  a blast of fire from its mouth. This calculates damage based off the lower of the targets' defense or special defense. Then, heals the user 5% of its max HP for each target hit.",
    },
    "m668": {
        "name": "Strength Sap",
        "type": types.GRASS,
    ...
    "m814": {
        ...
        "tier": moveTiers.POWER,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user slams targets with its wings. The primary target is hit twice in a row.",
    },
    "m876": {
        "name": "Pound",
        "type": types.NORMAL,
    ...
    "m20009": {
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.PHYSICAL,
        "description": "The user lets its swords draw from its own power, then slices three times at the target. Successful hits deal an additional 10% of the target's max HP true damage. If the primary target is defeated, targets random enemies without missing.",
    },
    "m20010": {
        "name": "Gear Fifth",
        "type": types.FAIRY,
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.OTHER,
        "description": "If under 25% HP, the user activates Gear Fifth, transforming into Sun God Infernape for 3 turns, then gives itself another turn and 50% HP. FAILS if the user is not under 25% HP.",
    },
    "m20011": {
        "name": "Dawn Rocket",
        "type": types.FAIRY,
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user bends the environment to propel itself through the opponent. Uses the minimum of the user and opponent's Special Defense to calculate damage.",
    },
    "m20012": {
        "name": "Monkey God Gun",
        "type": types.FIGHTING,
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.SPECIAL,
        "description": "The user inflates its fist to the size of an island, then crashes it down on the enemy team.",
    },
    "m20013": {
        "name": "ZA WATER!!!",
        "type": types.WATER,
        ...
        "tier": moveTiers.ULTIMATE,
        "damageType": damageTypes.OTHER,
        "description": "The user activates its Stand, ZA WATER!!!, forcing time to stop for all other Pokemon. This provides the user a buff granting it 2 extra turns.",
    },
};
...
const moveExecutes = {
    ...
    "m76": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        if (source.effectIds.absorbLight === undefined && !battle.isWeatherNegated() && battle.weather.weatherId !== weatherConditions.SUN) {
            ...
            for (const target of allTargets) {
                const miss = missedTargets.includes(target);
                const mult = battle.weather.weatherId !== weatherConditions.SUN && battle.weather.weatherId !== null && !battle.isWeatherNegated() ? 0.5 : 1;
                const damageToDeal = calculateDamage(moveData, source, target, miss, {
    ...
    "m208": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        for (const target of allTargets) {
            ...
            // heal
            source.giveHeal(Math.floor(source.maxHp * (0.4 + 0.1 * effects)), source, {
                type: "move",
                moveId: moveId
            });
        }
    ...
    "m311": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        for (const target of allTargets) {
            ...
            const damageToDeal = calculateDamage(moveData, source, target, miss, {
                "moveType": type,
                "power": moveData.power * (battle.weather.weatherId !== null && !battle.isWeatherNegated() ? 2 : 1)
            });
            source.dealDamage(damageToDeal, target, {
                type: "move",
                moveId: moveId
    ...
    "m331-1": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        if (source.effectIds.projectingSpirit === undefined) {
            ...
            for (let i = 0; i < 9; i++) {
                ...
                const damageToDeal = calculateDamage(moveData, source, target, miss) + (miss ? 0 : Math.floor(target.maxHp * 0.05));
                source.dealDamage(damageToDeal, target, {
                    type: "move",
                    moveId: moveId
                });
    ...
    "m404": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        for (const target of allTargets) {
            ...
            if (target === primaryTarget && !target.isFainted) {
                const secondDamageToDeal = calculateDamage(moveData, source, target, miss);
    ...
    "m20009": function (battle, source, primaryTarget, allTargets, missedTargets) {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (primaryTarget.isFainted) {
                ...
                const enemyPokemons = source.getEnemyParty().pokemons.filter(p => battle.isPokemonHittable(p, moveId));
                if (enemyPokemons.length === 0) {
                    break;
                }
                target = enemyPokemons[Math.floor(Math.random() * enemyPokemons.length)];
            }

            // deal damage
            const miss = missedTargets.includes(target);
            // if not miss, deal 10% of target's max hp
            const damageToDeal = calculateDamage(moveData, source, target, miss) + (miss ? 0 : Math.floor(target.maxHp * 0.1));
            source.dealDamage(damageToDeal, target, {
                type: "move",
                moveId: moveId
            });
...
const abilityConfig = {
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    battle.addToLog(`${sourcePokemon.name}'s Shadow Tag restricts all enemies!`);
    ...
    "25": {
        "name": "Wonder Guard",
        "description": "The user has 75% less HP. The user is immune to non-supereffective moves.",
        "abilityAdd": function (battle, source, target) {
            const listener = {
                initialArgs: {
                    pokemon: target,
                ...
                execute: function(initialArgs, args) {
                    ...
                    const damageMultiplier = sourcePokemon.getTypeDamageMultiplier(moveData.type, targetPokemon);
                    if (damageMultiplier <= 1) {
                        sourcePokemon.battle.addToLog(`${targetPokemon.name}'s Wonder Guard protects it from ${sourcePokemon.name}'s ${moveData.name}!`);
                        args.damage = 0;
                        args.maxDamage = 0;
                    }
                }
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    args.canAdd = false;
                    targetPokemon.battle.addToLog(`${targetPokemon.name}'s Clear Body prevents ${effectData.name}!`);
                }
            };
            const listenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_EFFECT_ADD, listener);
            return {
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    targetPokemon.battle.addToLog(`${initialArgs.pokemon.name} is exerting Conqueror's Pressure against ${targetPokemon.name}!`)
                    abilityData.affectedPokemons.push(targetPokemon);
                    ...
                    const damage = calculateDamage({
                        ...
                        "damageType": damageTypes.PHYSICAL,
                        "type": types.PSYCHIC,
                    }, initialArgs.pokemon, targetPokemon, false, {
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    if (ability.data.turn % 2 === 0) {
                        pokemon.battle.addToLog(`${pokemon.name}'s Old Age is holding it back!`);
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    targetPokemon.battle.addToLog(`${targetPokemon.name}'s Guts increases its attack!`);
                }
            }
            const listenerId = battle.eventHandler.registerListener(battleEventNames.AFTER_STATUS_APPLY, listener);
        ...
        "abilityAdd": function (battle, source, target) {
            ...
            const listener2 = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    targetPokemon.battle.addToLog(`${targetPokemon.name}'s Storm Drain was activated by the Water attack!`);
                    args.damage = 0;
                    args.maxDamage = 0;
                    targetPokemon.addEffect("spaUp", 1, targetPokemon);
                }
            ...
            const listenerId1 = battle.eventHandler.registerListener(battleEventNames.GET_ELIGIBLE_TARGETS, listener1);
            const listenerId2 = battle.eventHandler.registerListener(battleEventNames.BEFORE_DAMAGE_TAKEN, listener2);
            return {
                "listenerId1": listenerId1,
                "listenerId2": listenerId2,
            }
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    if (!battle.weather || battle.weather.weatherId !== weatherConditions.HAIL) {
                        return;
                    }

                    // heal 25% of max hp
                    battle.addToLog(`${activePokemon.name}'s Ice Body restores its health!`);
        ...
        "abilityAdd": function (battle, source, target) {
            ...
            const effectAndStatusListener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    sourcePokemon.battle.addToLog(`${sourcePokemon.name}'s Sheer Force prevents the status or effect!`);
                    args.canApply = false;
                    args.canAdd = false;
                }
            }
            ...
            const damageListenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_DAMAGE_DEALT, damageListener);
            const effectListenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_EFFECT_ADD, effectAndStatusListener);
            const statusListenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_STATUS_APPLY, effectAndStatusListener);
            return {
                "damageListenerId": damageListenerId,
                "effectListenerId": effectListenerId,
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    targetPokemon.battle.addToLog(`${sourcePokemon.name}'s Heavy Metal increases the damage!`);
                }
            }
            const listenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_DAMAGE_DEALT, listener);
            return {
            ...
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    if (sourcePokemon.effectIds["atkUp"]) {
                        sourcePokemon.battle.addToLog(`${sourcePokemon.name}'s Moxie greatly increases its attack!`);
                        sourcePokemon.addEffect("greaterAtkUp", 2, sourcePokemon);
                    } else {
                        sourcePokemon.battle.addToLog(`${sourcePokemon.name}'s Moxie increases its attack!`);
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    initialPokemon.battle.addToLog(`${initialPokemon.name}'s Magic Bounce reflects the move!`);
                    moveExecutes[args.moveId](battle, initialPokemon, sourcePokemon, [sourcePokemon], []);
                }
            }
            const listenerId = battle.eventHandler.registerListener(battleEventNames.BEFORE_MOVE_EXECUTE, listener);
            return {
                "listenerId": listenerId,
            };
        },
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    sourcePokemon.battle.addToLog(`${sourcePokemon.name}'s Prankster increases its combat readiness!`);
        ...
        "abilityAdd": function (battle, source, target) {
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    targetPokemon.battle.addToLog(`${targetPokemon.name}'s Competitive increases its special attack!`);
                    targetPokemon.addEffect("greaterSpaUp", 2, targetPokemon);
                }
            }
            const listenerId = battle.eventHandler.registerListener(battleEventNames.AFTER_EFFECT_ADD, listener);
            return {
                "listenerId": listenerId,
            }
        },
        ...
        "abilityAdd": function (battle, source, target) {
            ...
            const listener = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    // increase duration
                    pokemon.battle.addToLog(`${pokemon.name}'s Blue Haki increased the duration of ${effectData.name}!`);
                    args.duration += 1;
                }
            };
            // damage listener
            const listener2 = {
                ...
                execute: function(initialArgs, args) {
                    ...
                    if (isBuffed) {
                        pokemon.battle.addToLog(`${pokemon.name}'s Blue Haki increased its damage!`);
                        args.damage = Math.floor(args.damage * 1.25);
                    }
                }
            };

            const listenerId1 = battle.eventHandler.registerListener(battleEventNames.BEFORE_EFFECT_ADD, listener);
            const listenerId2 = battle.eventHandler.registerListener(battleEventNames.BEFORE_DAMAGE_DEALT, listener2);
            return {
                listenerId1: listenerId1,
                listenerId2: listenerId2,
            }
