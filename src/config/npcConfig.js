  ...
  [npcs.BUG_CATCHER]: {
    ...
    difficulties: {
      [difficulties.VERY_EASY]: {
        ...
        maxLevel: 4,
        numPokemon: 4,
        pokemonIds: ["10", "13", "165", "167", "265", pokemonIdEnum.KRICKETOT],
        aceId: "14",
      },
      [difficulties.EASY]: {
        minLevel: 12,
  ...
  [npcs.AROMA_LADY]: {
    ...
    difficulties: {
      ...
      [difficulties.EASY]: {
        ...
        maxLevel: 22,
        numPokemon: 5,
        pokemonIds: ["43", "152", "187", "192", "285", pokemonIdEnum.ROSELIA],
        aceId: "44",
      },
      [difficulties.MEDIUM]: {
        minLevel: 33,
        maxLevel: 40,
        numPokemon: 5,
        pokemonIds: ["44", "153", "188", "192", "286", pokemonIdEnum.ROSERADE],
        aceId: "44",
      },
      [difficulties.HARD]: {
        minLevel: 53,
  ...
  [npcs.DRAGON_TAMER]: {
    ...
    difficulties: {
      [difficulties.EASY]: {
        ...
        maxLevel: 24,
        numPokemon: 4,
        pokemonIds: ["5", "147", "328", "333", pokemonIdEnum.GIBLE],
        aceId: "147",
      },
      [difficulties.MEDIUM]: {
        minLevel: 32,
