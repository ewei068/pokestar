...
const bannerConfigRaw = [
  ...
  {
    bannerType: bannerTypes.SPECIAL,
    name: "[GEN 4] Pokemon of Myth",
    description:
      "Gen 4 has arrived! Pull for the legendary Dialga, Palkia, and Giratina, as well as other Gen 4 Pokemon! NOTE: These Pokemon are NOT limited and are available in all banners.",
    rateUp: () => ({
      [rarities.LEGENDARY]: [
  ...
  /**
    ...
    description:
      "Gen 4 has arrived! Pull for the legendary Heatran, Cresselia, Regiggas, as well as other Gen 4 Pokemon! NOTE: These Pokemon are NOT limited and are available in all banners.",
    rateUp: () => ({
      [rarities.LEGENDARY]: [
