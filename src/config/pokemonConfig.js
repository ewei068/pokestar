...
const pokemonConfig = {
    ...
    "251": {
        ...
        "noGacha": true,
        "mythicConfig": {
            [rarities.LEGENDARY]: ["9-1", "25-1", "52-1", "136-1", "139-1", "145-1", "150-1", "150-2", "249-1", "302-1", "384-1", "392-1", "828-1"],
            [rarities.EPIC]: ["18-1", "24-1", "34-1", "49-1", "110-1", "123-1", "131-1", "143-1", "157-1", "237-1", "248-1", "289-1", "319-1"]
        }
    },
    "252": {
        "name": "Treecko",
    ...
    "10001": {
        ...
        "shinySprite": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/10001.png",
        "abilities": {
            "46": 1,
        },
        "moveIds": ["m239", "m245", "m406", "m620"],
    ...
    "10002": {
        ...
        "shinySprite": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/10002.png",
        "abilities": {
            "46": 1,
        },
        "moveIds": ["m239", "m245", "m406", "m620"],
    ...
    "10003": {
        ...
        "shinySprite": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/10003.png",
        "abilities": {
            "20001": 1,
        },
        "moveIds": ["m239", "m245", "m406", "m20007"],
        "battleEligible": true,
        "rarity": rarities.MYTHICAL,
        "growthRate": growthRates.SLOW,
        "noGacha": true,
    ...
    "20150-1": {
        ...
        "emoji": "<:armoredmewtwo:1117130461282578535>",
        "description": "The superpowered Mewtwo under the control of Team Rocket GO. Many trainers must band together to take down this mighty foe.",
        "type": [types.PSYCHIC, types.STEEL],
    ...
    "20249-1": {
        ...
        "emoji": "<:shadowlugia:1127311851278061608>",
        "description": "The legendary Lugia corrupted by Team Rocket GO. It's violent rampage requires multiple strong trainers to take down.",
        "type": [types.GHOST, types.FLYING],
