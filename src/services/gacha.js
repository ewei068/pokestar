...
const generateRandomPokemon = (userId, pokemonId, level=5, { equipmentLevel=1, isShiny=null, betterIvs=false}={}) => {
    ...
    isShiny = isShiny === null ? drawUniform(0, shinyChance, 1)[0] == 0 : isShiny;
